<template>
  <div class="md:w-10/12 xl:w-2/3 mx-auto xl:px-8">
    ...
    <div class="font-semibold relative space-x-20 xl:space-x-0">
      <span class="text-4xl absolute top-1/2 xl:-left-4 transform -translate-y-1/2 xl:-translate-x-full p-4 rounded-full isax-save-2 text-yellow-700 bg-yellow-50"></span>
